...
namespace Cheat
{
	...
	void FivemSDK::Intialize()
	{
		...
		else if (FrameWork::Memory::GetProcessPidByName(XorStr(L"FiveM_GTAProcess.exe")) || FrameWork::Memory::GetProcessPidByName(XorStr(L"FiveM_GTAProcess.exe")))
		{
			Pid = FrameWork::Memory::GetProcessPidByName(XorStr(L"FiveM_GTAProcess.exe"));
			if (Pid)
			{
				GameVersion = GAME_VERSION_GAME_b3258;
				ModuleName = XorStr("FiveM_GTAProcess.exe");
			}
			else
			{
				Pid = FrameWork::Memory::GetProcessPidByName(XorStr(L"FiveM_GTAProcess.exe"));
		...
		else if (FrameWork::Memory::GetProcessPidByName(XorStr(L"FiveM_b3323_GameProcess.exe")) || FrameWork::Memory::GetProcessPidByName(XorStr(L"FiveM_b3323_GTAProcess.exe")))
		{
			Pid = FrameWork::Memory::GetProcessPidByName(XorStr(L"FiveM_b3323_GameProcess.exe"));
			if (Pid)
			{
				GameVersion = GAME_VERSION_GAME_b3323;
				ModuleName = XorStr("FiveM_b3323_GameProcess.exe");
			}
			else
			{
				Pid = FrameWork::Memory::GetProcessPidByName(XorStr(L"FiveM_b3323_GTAProcess.exe"));
				GameVersion = GAME_VERSION_GTA_b3323;
				ModuleName = XorStr("FiveM_b3323_GTAProcess.exe");
			}
		...
		else if (FrameWork::Memory::GetProcessPidByName(XorStr(L"FiveM_b3407_GameProcess.exe")) || FrameWork::Memory::GetProcessPidByName(XorStr(L"FiveM_b3407_GTAProcess.exe")))
		{
			Pid = FrameWork::Memory::GetProcessPidByName(XorStr(L"FiveM_b3407_GameProcess.exe"));
			if (Pid)
			{
				GameVersion = GAME_VERSION_GAME_b3407;
				ModuleName = XorStr("FiveM_b3407_GameProcess.exe");
			}
			else
			{
				Pid = FrameWork::Memory::GetProcessPidByName(XorStr(L"FiveM_b3407_GTAProcess.exe"));
				GameVersion = GAME_VERSION_GTA_b3407;
				ModuleName = XorStr("FiveM_b3407_GTAProcess.exe");
			}
		...
		else if (FrameWork::Memory::GetProcessPidByName(XorStr(L"FiveM_GameProcess.exe")) || FrameWork::Memory::GetProcessPidByName(XorStr(L"FiveM_GameProcess.exe")))
		{
			Pid = FrameWork::Memory::GetProcessPidByName(XorStr(L"FiveM_GameProcess.exe"));
			if (Pid)
			{
				GameVersion = GAME_VERSION_GAME_b3258;
				ModuleName = XorStr("FiveM_GameProcess.exe");
			}
			else
			{
				Pid = FrameWork::Memory::GetProcessPidByName(XorStr(L"FiveM_GameProcess.exe"));
